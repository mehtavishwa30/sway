...
// check: $(val_ary_as_string=$VAL) = get_ptr mut ptr [b256; 2] $val_ary, string<40>, 0

// check: $(val_ary_0_as_b256=$VAL) = get_ptr mut ptr [b256; 2] $val_ary, b256, 0
...
// check: $(val_ary_1_as_b256=$VAL) = get_ptr mut ptr [b256; 2] $val_ary, b256, 1
...
// check: $(val_ary_ptr=$VAL) = get_ptr mut ptr [b256; 2] $val_ary, string<40>, 0
