...
fn convert_resolved_type(
    ...
    Ok(match ast_type {
        ...
        TypeInfo::UnsignedInteger(_) => Type::new_uint(context, 64),
        TypeInfo::Numeric => Type::new_uint(context, 64),
        TypeInfo::Boolean => Type::new_bool(context),
        TypeInfo::B256 => Type::new_b256(context),
        ...
        TypeInfo::RawUntypedPtr => Type::new_uint(context, 64),
        TypeInfo::RawUntypedSlice => Type::new_slice(context),
