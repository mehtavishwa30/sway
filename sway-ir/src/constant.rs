...
impl Constant {
    pub fn new_unit(context: &mut Context) -> Self {
        Constant {
            ty: Type::new_unit(context),
            value: ConstantValue::Unit,
        }
    }

    pub fn new_bool(context: &mut Context, b: bool) -> Self {
        Constant {
            ty: Type::new_bool(context),
    ...
    pub fn new_b256(context: &mut Context, bytes: [u8; 32]) -> Self {
        Constant {
            ty: Type::new_b256(context),
